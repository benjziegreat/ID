...
//        $view->loginCheck();
...

    {
      //  debugger;
        ...
        <script type="text/javascript">
            var employeeData = null, seriesIDs = '', typeData = null;//05132025: Updated May 13 2025 add typeData
            ...
            function initialLoad() {
                 $.ajax({
                    ...
                    data: {
                        ...
                        GETPARAM: {
                            recid: employeeData,
                            type: typeData //05132025: Updated May 13 2025
                        }
                    },
                    dataType: 'json',
                    async: false,
            ...
            function LoadIDData(data) {
                ...
                for (var i = 0; i < data.length-1; i++) {
                    ...
                    if(data[i].designation=="Junior High School"){
                        logoback="jrhighschool";
                    }else  if(data[i].designation=="Senior High School"){
                     ...
                     <div style="width:auto;">\n\
                              ...
                              <div id="div_img_id_front" style="border-radius:10px;border: rgba(153, 153, 153, 0) dashed 0.5px;width:'+data[i].idwidth+';height:'+data[i].idheight+';position:relative;float:left;">\n\
                                  <img id="img_front" src="../../../../ID/documents/zzzIDSetupImage/Front'+data[i].setupid+'.png?' + new Date() + '" style="border-radius:5px;width:'+data[i].idwidth+';height:'+data[i].idheight+';" alt="Emp ID">\n\
                                   <div id="emp_pic' + i + '" style="width:'+data[i].picwidth+';height:'+data[i].picheight+';top:0px;position:absolute;margin-top: 76px;right: 10px;text-align: center;">\n\
                                      <img src="../../../documents/StudentPictures/' + data[i].emp_id + '.png" style="width:'+data[i].picwidth+';height:'+data[i].picheight+';border: #C15858 solid thin;border-color: transparent;border-radius: 5px;" alt="">\n\
                                  </div> \n\
                          ...
                          <div id="_back" style="display: inline-block;    padding: 10px 0px 30px 20px;"> \n\
                             <div id="div_img_id_back" style="border-radius:10px;border: rgba(153, 153, 153, 0) dashed 0.5px;width:'+data[i].idwidth+';height:'+data[i].idheight+';position:relative;float:right;"> \n\
                                ...
                                <div id="s_SSS' + i + '" style="display:none;position: absolute;top: 0;margin-top: 25px;left: 55px;font-size: 12px;width: 80%;text-align: left;-webkit-transform: scale(0.7081,0.9175);font-weight: bold;"> <span>' + data[i].sssgsisno + '</span></div>\n\
                                 <div id="s_tinno' + i + '" style="display:none;position: absolute;top: 0;margin-top: 45px;left: 55px;font-size: 12px;width: 80%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;"> <span>' + data[i].tinno + '</span></div>\n\
                                 <div id="s_philhealth' + i + '" style="display:none;position: absolute;top: 0;margin-top: 64px;left: 55px;font-size: 12px;width: 80%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;"> <span>' + data[i].philno + '</span></div> \n\
                                <div id="s_birthdate' + i + '" style="position: absolute;top: 0;margin-top: 83px;left: 55px;font-size: 12px;width: 80%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;">  <span>' + data[i].birthdatevalue + '</span></div>\n\
                                 <div id="p_civil' + i + '' + i + '" style="display:none;position: absolute;top: 0;margin-top: 103px;left: 55px;font-size: 12px;width: 80%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;"> <span>' + data[i].status + '</span></div>\n\
                                 ...
                                 <div id="p_cellno' + i + '" style="position: absolute; top: 0;margin-top:197px; left: 55px; font-size: 12px; width: 80%; text-align: left; transform: scale(0.7081, 0.9175); font-weight: bold;"> <span>' + data[i].contactno + ' </span></div>\n\
                                ...
                                <img src="../../../documents/StudentSignature/' + data[i].emp_id + '.png?Thu Sep 03 2015 21:51:26 GMT-0700 (Pacific Daylight Time)" style="/*width: 160px;height: 35px;*/height:50px;border: #C15858 solid thin;border-color: transparent;border-radius: 5px;" alt=""> \n\
                                 </div> \n\
                            </div>\n\
                         </div> \n\
                      </div> \n\
                    ...
                    if (file_exists("../../../documents/StudentPictures/" + data[i].emp_id + ".png")) {
                        $('#emp_pic' + i + ' img').attr("src", '../../../documents/StudentPictures/' + data[i].emp_id + ".png" + "?time=" + new Date());
                    } else {
                        //Picture not exist.
                        $('#emp_pic' + i + ' img').attr("src", '../../../documents/StudentPictures/nopic.png' + "?time=" + new Date());
                    }
                    if (file_exists("../../../documents/StudentSignature/" + data[i].emp_id + ".png")) {
                        $('#emp_signature' + i + ' img').attr("src", '../../../documents/StudentSignature/' + data[i].emp_id + ".png" + "?time=" + new Date());
                    } else {
                        //Picture not exist.
                        $('#emp_signature' + i + ' img').attr("src", '../../../documents/StudentSignature/nopic.png' + "?time=" + new Date());
                    }
//                      if(fullname.length>26){
//                       $('div[id="emp_name' + i + '"]').map(function(index, elem) {
//                            fitTextInBox(elem);
//                       });
//                      }
//                       if(guardianname.length>26){
    ...
    <div class="container" style="color:black;font-family: Arial,sans-serif;    padding: 0px 3.5% 0px 0%;">
        <div class="panel-heading" id="divTopHeader" style="height: 40px;width: 100%;padding: 0px;">           
            <div class="col-md-12" style="float:left;margin-top:3px;">
                <button onclick="printFrame()"  name="btnPrintID" class="btn btn-info btn-lg" title="Print ID" style="padding: 7px 12px;float: right;font-size: 12px;min-width: 80px;margin-right: 0.5%;">
