...
function msgBox(msg, title,icon,buttons,mbWidth,mbHeight,callBackFunction){
    ...
    if(mbWidth==null || mbWidth<350){mbWidth=350;}    
    if(mbHeight==null || mbHeight<180){mbHeight=180;}
   ...
   if(buttons=='' || buttons==null){        
    ...
    var objBoxIconDiv = document.createElement("div");
    objBoxIconDiv.id = "___msgIconDiv";    
    ...
    $("#___msgContainer").append(objBoxIconDiv);    
    $("#___msgContainer").append(objBoxMsg);    
    $("#___msgIconDiv").append(objBoxIcon);
    
    $("#___msgIconDiv").css("width", "70px");
    $("#___msgIconDiv").css("height", "70px");
    //$("#___msgIconDiv").css("margin", "15px");
    
    $("#___msgIcon").attr("src", "../images/icon/"+icon+".png");
    $("#___msgIcon").attr("align", "left");
    //$("#___msgIcon").css("padding", "5px");
    $("#___msgIcon").css("margin", "5px");
    
    $("#___msgText").css("margin", "5px");
    $("#___msgText").html(msg);
