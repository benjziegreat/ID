...
//                LoadIDData(employeeData);
            ...
            function LoadIDData(data) {
                ...
                for (var i = 0; i < data.length-1; i++) {
                    ...
                    var fullname = data[i].lname.toString().toUpperCase().split(' ').join(' ') + ', '+ data[i].fname.toString().capitalizeFirst()+'<br style="content: &quot;&quot;;margin: 0px; display: block;">' + ($.trim(data[i].mname) == "." ? "." : data[i].mname.toString().toUpperCase());
                    ...
                    var strDivID = '<div style="text-align:center;display:inline-block;" id="div_print_id' + i + '">\n\
                     <div style="width:auto;">\n\
                           <div id="_front" style="display:inline-block;border-right:black solid thin;   padding: 10px 10px 20px 0px;">\n\
                              <div id="div_img_id_front" style="border-radius:10px;border: rgba(153, 153, 153, 0) dashed 0.5px;width:'+data[i].idwidth+';height:'+data[i].idheight+';position:relative;float:left;">\n\
                                  ...
                                  <div id="emp_pic' + i + '" style="width:'+data[i].picwidth+';height:'+data[i].picheight+';top:0px;position:absolute;margin-top: 76px;right: 10px;text-align: center;">\n\
                                      <img src="../../../documents/AlumniPictures/' + data[i].emp_id + '.png" style="width:'+data[i].picwidth+';height:'+data[i].picheight+';border: #C15858 solid thin;border-color: transparent;border-radius: 5px;" alt="">\n\
                                  </div> \n\
                                 ...
                                 <div id="emp_batch' + i + '" style="top: 0px; position: absolute; margin-top: 62px; font-weight: bold; margin-left: 0px; text-align: center; right: 1px; width: 42%; transform: scale(0.89051, 1.01357); left: -3px; box-sizing: initial;">\n\
                                      <span style="font-size: 10px; box-sizing: initial;">Batch: '+data[i].batch+'</span>\n\
                                 </div> \n\
                                 <div id="emp_name' + i + '" style="top:0px;position:absolute;margin-top: 177px;font-weight: bold;margin-left: 0px;text-align: left;right: 1px;/* width: 60%*/; -webkit-transform: scale(0.89051,1.013570);"> \n\
                                 ...
                                 <div id="emp_idtype' + i + '" style="top:0px;position:absolute;margin-top: 216.2px;font-weight: bold;text-align: left;left: 68px;font-size: 9px;width: 60%;-webkit-transform: scale(1.00516999,1.0140357);"> \n\
                                     <span>' + data[i].category + '</span>\n\
                                 </div> \n\
                                 <div id="emp_position' + i + '" style="top:0px;position:absolute;margin-top: 192px;font-weight: bold;margin-left: 0px;text-align: left;right: 1px; width:70%; -webkit-transform: scale(0.89051,1.013570);"> \n\
                                     <span style="font-size:10px;" >' + data[i].designation + '</span>\n\
                                 </div> \n\
                          ...
                          <div id="_back" style="display: inline-block;    padding: 0px 0px 20px 7px;"> \n\
                             <div id="div_img_id_back" style="border-radius:10px;border: rgba(153, 153, 153, 0) dashed 0.5px;width:'+data[i].idwidth+';height:'+data[i].idheight+';position:relative;float:right;"> \n\
                                <img id="img_back" src="../../../../ID/documents/zzzIDSetupImage/BACK'+data[i].setupid+'.png?' + new Date() + '" style="border-radius:5px;width:'+data[i].idwidth+';height:'+data[i].idheight+';" alt="Emp ID">\n\
                                 <div id="s_SSS' + i + '" style="position: absolute;top: 0;margin-top: 25px;left: 45px;font-size: 12px;width: 90%;text-align: left;-webkit-transform: scale(0.7081,0.9175);font-weight: bold;"> <span>' + data[i].sssgsisno.toString() + '</span></div>\n\
                                 <div id="s_tinno' + i + '" style="position: absolute;top: 0;margin-top: 45px;left: 45px;font-size: 12px;width: 90%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;"> <span>' + data[i].tinno.toString() + '</span></div>\n\
                                 <div id="s_philhealth' + i + '" style="position: absolute;top: 0;margin-top: 64px;left: 45px;font-size: 12px;width: 90%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;"> <span>' + data[i].philno.toString() + '</span></div> \n\
                                <div id="s_birthdate' + i + '" style="position: absolute;top: 0;margin-top: 83px;left: 45px;font-size: 12px;width: 90%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;">  <span>' + data[i].birthdatevalue.toString() + '</span></div>\n\
                                 <div id="p_civil' + i +  '" style="position: absolute;top: 0;margin-top: 103px;left: 45px;font-size: 12px;width: 90%;text-align: left;-webkit-transform: scale(0.7081,0.9175); font-weight: bold;"> <span>' + data[i].status.toString() + '</span></div>\n\
                                 ...
                                 <div id="p_cellno' + i + '" style="position: absolute; top: 0;margin-top:197px; left: 45px; font-size: 12px; width: 90%; text-align: left; transform: scale(0.7081, 0.9175); font-weight: bold;"> <span>' + data[i].contactno.toString() + ' </span></div>\n\
                                 <div id="emp_signature' + i + '" style="width: 100%;position: relative;top: 0;margin-top: -56px;-webkit-transform: scale(0.91,0.975); font-weight: bold;">\n\
                                     <img src="../../../documents/AlumniSignature/' + data[i].emp_id + '.png?Thu Sep 03 2015 21:51:26 GMT-0700 (Pacific Daylight Time)" style="/*width: 160px;height: 35px;*/height:50px;border: #C15858 solid thin;border-color: transparent;border-radius: 5px;" alt=""> \n\
                                 </div> \n\
                            </div>\n\
                         </div> \n\
                      </div> \n\
                    ...
                    if (file_exists("../../../documents/AlumniPictures/" + data[i].emp_id + ".png")) {
                        $('#emp_pic' + i + ' img').attr("src", '../../../documents/AlumniPictures/' + data[i].emp_id + ".png" + "?time=" + new Date());
                    } else {
                        //Picture not exist.
                        $('#emp_pic' + i + ' img').attr("src", '../../../documents/AlumniPictures/nopic.png' + "?time=" + new Date());
                    }
                    if (file_exists("../../../documents/AlumniSignature/" + data[i].emp_id + ".png")) {
                        $('#emp_signature' + i + ' img').attr("src", '../../../documents/AlumniSignature/' + data[i].emp_id + ".png" + "?time=" + new Date());
                    } else {
                        //Picture not exist.
                        $('#emp_signature' + i + ' img').attr("src", '../../../documents/AlumniSignature/nopic.png' + "?time=" + new Date());
                    }
                    
//                    $('div[id="s_mother' + i + '"]').map(function(index, elem) {
//                        fitTextInBox(elem);
//                    });
                       // $('div[id^="div_img_id_front"],div[id^="div_img_id_back"]').css({'width': '8.35cm', 'height': '5.34cm'});
//                        $('div[id^="_front"]').css({'border-bottom': 'black solid thin', 'border-right': 'none', 'padding-top': '10px', 'padding-bottom': '10px', 'margin-right': '150px'});
//                        $('div[id^="_back"]').css({'margin-right': '168px', 'display': '', 'padding-top': '10px'});
//                        $('div[id^="_front",div[id^="_back"]').css({'width': '8.35cm', 'height': '5.3cm'});
            ...
            function loadXYSetupID(data) {
                for (var i = 0; i < data.length-1; i++) {
                    ...
                    var frontpicturexy = data[i].frontpicturexy.toString().split(';');
                    ...
                    var frontbatchxy = data[i].frontbatchxy.toString().split(';');
                    arrp1 = frontbatchxy[0].split(':');
                    arrp2 = frontbatchxy[1].split(':');
                    arrp3 = frontbatchxy[2].split(':');
                    $('div[id="emp_batch' + i + '"]').css(arrp1[0], arrp1[1]).css(arrp2[0], arrp2[1]);
                    $('div[id="emp_batch' + i + '"] span').css(arrp3[0], arrp3[1]);
                    
                    var frontnamexy = data[i].frontnamexy.toString().split(';');
                    ...
                    var frontdesignationxy = data[i].frontdesignationxy.toString().split(';');
                    ...
                    var frontidnumxy = data[i].frontidnumxy.toString().split(';');
                    ...
                    var frontcategoryxy = data[i].frontcategoryxy.toString().split(';');
                    ...
                    var frontbarcodexy = data[i].frontbarcodexy.toString().split(';');
                    ...
                    var backsssgsisnoxy = data[i].backsssgsisnoxy.toString().split(';');
                    ...
                    var backtinxy = data[i].backtinxy.toString().split(';');
                    ...
                    var backphihealthxy = data[i].backphihealthxy.toString().split(';');
                    ...
                    var backdateofbirthxy = data[i].backdateofbirthxy.toString().split(';');
                    ...
                    var backcivilstatusxy = data[i].backcivilstatusxy.toString().split(';');
                    ...
                    var backguardiannamexy = data[i].backguardiannamexy.toString().split(';');
                    ...
                    var backguardianaddressxy = data[i].backguardianaddressxy.toString().split(';');
                    ...
                    var backguardiantelnoxy = data[i].backguardiantelnoxy.toString().split(';');
                    ...
                    var backsignaturexy = data[i].backsignaturexy.toString().split(';');
...
//        console.log(url);
            ...
            function printFrame(printingType) {
                            ...
                            success: function (emp_id) {
                                ...
                                if (emp_id !== "") {
                                    ...
                                    if(printingType==='PVC'){
                                        ...
                                        console.log('printFrame-> printingType', printingType);
                                        $('div[id="_front"]').css('padding-left','10px');
                                    }
                                    printDivData_WP('idContainer', 'P','_self', printingType);
                                } else {
                                    console.log(emp_id);
