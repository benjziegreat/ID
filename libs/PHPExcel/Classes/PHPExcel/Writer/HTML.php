...
//        /* Safari */
//        $css['-webkit-transform']= "rotate(-{$pStyle->getTextRotation()}deg)";
//
//        /* Firefox */
//        $css['-moz-transform']= "rotate(-{$pStyle->getTextRotation()}deg)";
//
//        /* IE */
//        $css['-ms-transform']= "rotate(-{$pStyle->getTextRotation()}deg)";
//
//        /* Opera */
//        $css['-o-transform']= "rotate(-{$pStyle->getTextRotation()}deg)";
...
//        var_dump($pStyle);
		...
		$css =(($borderStyle == 'none')? "1px solid #ffffff" :  $borderStyle . " #".$pStyle->getColor()->getRGB()) . (($borderStyle == 'none') ? '' : ' !important');
//        $css = $borderStyle;
//
//        if($borderStyle!='none'){
//            $css .= ' #' . $pStyle->getColor()->getRGB() . (($borderStyle == 'none') ? '' : ' !important');
//        }
